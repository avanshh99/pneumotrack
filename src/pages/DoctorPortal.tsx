...
//       // Store logged-in doctor info using jwt
//       localStorage.setItem('authToken', data.token);
//       localStorage.setItem('loggedInDoctor', JSON.stringify(data.doctorInfo));
//       // Handle Remember Me
...
const DoctorLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Response Text:', responseText); // Check this in your console
