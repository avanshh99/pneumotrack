    ...
    <footer className="bg-pneumo-darkBlue text-white">
      <div className="container py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-300">
              Advanced pneumonia detection platform powered by AI, connecting patients with specialists.
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/doctor-portal" className="text-sm text-gray-300 hover:text-white transition-colors">Doctor Portal</Link></li>
              <li><Link to="/patient-portal" className="text-sm text-gray-300 hover:text-white transition-colors">Patient Portal</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li className="text-sm text-gray-300">support@pneumotack.com</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between text-sm text-gray-400">
          <p>© 2024 PneumoTack. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
